# script de verrouillage du dossier des cartes Arduino seulement
# Script powershell appelé par Encapsarduino
...
function Lock-Folders {
    ...
    $balloon.ShowBalloonTip(5000, "Arduino IDE", "DOSSIER CARTES VERROUILLE", "Info")
}
...
function Unlock-Folders {
    ...
    $balloon.ShowBalloonTip(5000, "Arduino IDE", "DOSSIER CARTES DEVERROUILLE", "Info")
}
